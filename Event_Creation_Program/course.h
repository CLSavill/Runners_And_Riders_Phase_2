...
private:
    ...
    void set_letter(std::string); //Member function that will set the letter of the course.
    void set_number_of_nodes(int number); //Member function that will set the number of nodes of the course.
    ...
    void check_node_exists(int number); //Member function that checks that the node being added exists in the nodes available array.
    void export_course(); //Member function that will export the course's letter, number of nodes and list of nodes to a '.txt' file.
};
